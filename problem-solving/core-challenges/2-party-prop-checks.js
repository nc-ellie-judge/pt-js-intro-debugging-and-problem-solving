...
runTest(
  "counts the props when only one item is in stock",
  function () {
    check(partyPropCheck({balloons: {
      purple: 3, 
    }, }, 'purple')).isEqualTo(3);
    check(partyPropCheck({balloons: {
      purple: 3, 
...
skipTest(
  "counts the items where multiple items are in the stock",
  function () {
    check(partyPropCheck({balloons: {
      purple: 3, 
    }, ribbons: {
...
skipTest(
  "counts rainbow items in addition to those of specific",
  function () {
    check(partyPropCheck({balloons: {
      purple: 3, 
    }, ribbons: {
